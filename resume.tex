...
\section{EXPERIENCE} 
	...
	{\sl Desk Side Support Intern} \hfill June 2010 - Present \\
                Dell-Perot Systems, San Jose, CA
                 \begin{itemize}  \itemsep -2pt % reduce space between items
                 \item Responded to technical incidents and requests in a hospital
		 \item Imaged computers, troublshot hardware and software issues
                \end{itemize}
	...
	{\sl Mobile Developer, Web Development Team Leader} \hfill February 2010 - Present \\
                ...
                {\sl Office Assistant} \hfill            Fall 2006 - Present \\
                ...
                Macapper.com
                  \begin{itemize}
                   ...
                   \end{itemize}
				{\sl Laborer} \hfill        Summer 2006 \\
                CL Lewis Construction, Lynchburg, VA
                  \begin{itemize}
                   \item Assisted with multiple construction projects, including concrete pouring, installation of interior fixtures and clean-up
                   \end{itemize}
